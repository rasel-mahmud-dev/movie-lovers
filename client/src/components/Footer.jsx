...
export default function Footer() {
    return (
        <div className='bg-dark-700 '>
            <footer class="footer p-10 my_container text-base-content">
                <div>
            ...
            <footer class="footer  my_container px-10 py-4 border-t bg-dark-700 text-base-content border-base-300">
